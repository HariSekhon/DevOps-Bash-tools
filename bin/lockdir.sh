...
Warning: a 'kill -9' of the script cannot be trapped and will leave behind the lock dir and pidfile.
         That would require a manual cleanup using the same rm and rmdir command combo (safer than rm -rf)
"

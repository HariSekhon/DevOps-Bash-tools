...
#exec docker run -ti --rm -e APPVEYOR_TOKEN -v "$PWD":/pwd -w /pwd harisekhon/appveyor:debian ./appveyor_byoc.sh
exec docker run -ti --rm -e APPVEYOR_TOKEN harisekhon/appveyor:debian

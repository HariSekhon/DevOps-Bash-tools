...
11 original source git repos with 284 continuous integration builds:
...
[![Travis CI](https://img.shields.io/travis/harisekhon/DevOps-Perl-tools/master?logo=travis)](https://travis-ci.org/HariSekhon/DevOps-Perl-tools)
[![AppVeyor](https://img.shields.io/appveyor/build/harisekhon/DevOps-Perl-tools/master?logo=appveyor)](https://ci.appveyor.com/project/HariSekhon/DevOps-Perl-tools/branch/master)
[![Drone](https://img.shields.io/drone/build/HariSekhon/DevOps-Perl-tools/master?logo=drone)](https://cloud.drone.io/HariSekhon/DevOps-Perl-tools)
...
[![Shippable]([![Codeship Status for HariSekhon/DevOps-Perl-tools](https://app.codeship.com/projects/c9e3bf70-3c5f-0138-d157-661d474a0ccb/status?branch=master)](https://app.codeship.com/projects/387254))](https://app.shippable.com/github/HariSekhon/DevOps-Perl-tools/dashboard/jobs)
...
[![Travis CI](https://img.shields.io/travis/harisekhon/HAProxy-configs/master?logo=travis)](https://travis-ci.org/HariSekhon/HAProxy-configs)
[![AppVeyor](https://img.shields.io/appveyor/build/harisekhon/HAProxy-configs/master?logo=appveyor)](https://ci.appveyor.com/project/HariSekhon/HAProxy-configs/branch/master)
[![Drone](https://img.shields.io/drone/build/HariSekhon/HAProxy-configs/master?logo=drone)](https://cloud.drone.io/HariSekhon/HAProxy-configs)
...
[![Shippable](https://api.shippable.com/projects/5e52c635b15ffc00071d8f7a/badge?branch=master)](https://app.shippable.com/github/HariSekhon/HAProxy-configs/dashboard/jobs)
...
[![BitBucket Pipeline](https://img.shields.io/bitbucket/pipelines/harisekhon/haproxy-configs/master?logo=bitbucket)](https://bitbucket.org/harisekhon/haproxy-configs/addon/pipelines/home#!/)
[![GitLab Pipeline](https://img.shields.io/gitlab/pipeline/harisekhon/HAProxy-configs?logo=gitlab)](https://gitlab.com/HariSekhon/HAProxy-configs/pipelines)
...
[![Travis CI](https://img.shields.io/travis/harisekhon/lib/master?logo=travis)](https://travis-ci.org/HariSekhon/lib)
[![AppVeyor](https://img.shields.io/appveyor/build/harisekhon/lib/master?logo=appveyor)](https://ci.appveyor.com/project/HariSekhon/lib/branch/master)
[![Drone](https://img.shields.io/drone/build/HariSekhon/lib/master?logo=drone)](https://cloud.drone.io/HariSekhon/lib)
...
[![Shippable](https://api.shippable.com/projects/5e52c6364c324200063326d5/badge?branch=master)](https://app.shippable.com/github/HariSekhon/lib/dashboard/jobs)
...
[![BitBucket Pipeline](https://img.shields.io/bitbucket/pipelines/harisekhon/lib/master?logo=bitbucket)](https://bitbucket.org/harisekhon/lib/addon/pipelines/home#!/)
[![GitLab Pipeline](https://img.shields.io/gitlab/pipeline/harisekhon/lib?logo=gitlab)](https://gitlab.com/HariSekhon/lib/pipelines)
...
11 git repos summarized with 284 continuous integration builds

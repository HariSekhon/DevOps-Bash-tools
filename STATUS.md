...
![Stars](https://img.shields.io/badge/Stars-2370-blue?logo=github)
![Forks](https://img.shields.io/badge/Forks-1073-blue?logo=github)
![Followers](https://img.shields.io/badge/Followers-422-blue?logo=github)
...
![Lines of Code](https://img.shields.io/badge/lines%20of%20code-200.3k-lightgrey?logo=codecademy)
[![GitStar Ranking Profile](https://img.shields.io/badge/GitStar%20Ranking-HariSekhon-blue?logo=github)](https://gitstar-ranking.com/HariSekhon)
![Last Generated](https://img.shields.io/badge/Last%20Generated-2020--09--07-lightgrey?logo=github)
...
13 original source git repos with 460 CI builds (427 hosted, 33 self-hosted):
...
400+ DevOps Bash Scripts - AWS, GCP, Kubernetes, Kafka, Docker, Hadoop, SQL, PostgreSQL, MySQL, Hive, Impala, CI, Jenkins, Concourse, GitHub, GitLab, BitBucket, Spotify, MP3, LDAP, Code/Build Linting, package management for Linux, Mac, Python, Perl, Ruby, NodeJS, Golang, Advanced Config dotfiles: .bashrc, .vimrc, .screenrc, .tmux.conf, .gitconfig, .psqlrc ...
...
80+ SQL Scripts - PostgreSQL, MySQL, Google BigQuery, MariaDB, AWS Athena - for DevOps & Analytics - Google BigQuery ML machine learning classification, DBA, DevOps, performance engineering
...
13 git repos summarized with 460 CI builds(427 hosted, 33 self-hosted)

...
usage_description="Returns a list of Shippable projects ids and names"
...
"$srcdir/shippable_api.sh" "/projects?sortBy=createdAt&sortOrder=-1&ownerAccountIds=$SHIPPABLE_ACCOUNT_ID" "$@" |
jq -r '.[] | [.id, .name] | @tsv'

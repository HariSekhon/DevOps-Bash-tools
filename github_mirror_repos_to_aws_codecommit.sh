...
Useful to create/sync GitHub repos to AWS CodeCommit for migration or to cron for fast free DR purposes. Includes repo descriptions but not PRs/Wikis/Releases

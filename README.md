...
- `terraform_*.sh` - [Terraform](https://www.terraform.io/) scripts:
  ...
  - `terraform_import_aws_sso_account_assignment.sh` - parses Terraform plan output to import new `aws_ssoadmin_account_assignment` items into Terraform state
  - `terraform_import_aws_sso_managed_policy_attachment.sh` - parses Terraform plan output to import new `aws_ssoadmin_account_assignment` items into Terraform state
  - `terraform_import_aws_sso_permission_set_inline_policy.sh` - parses Terraform plan output to import new `aws_ssoadmin_permission_set_inline_policy` items into Terraform state

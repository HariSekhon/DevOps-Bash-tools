...
- `postgres_*.sh` - various scripts using `psql.sh` to output clean lists of databases, schemas and tables for easy reuse in scripting, eg. `postgres_foreach_table.sh` and row counts for all tables

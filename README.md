...
- `kubernetes_join_cmd.sh` - constructs the `kubeadm join` command for joining an existing cluster by calculating the certificate hash and generating a new token, prints out the entire command for copy-paste / scripting convenience

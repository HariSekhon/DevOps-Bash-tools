...
- `git/*.sh` - [Git](https://git-scm.com/) scripts:
  ...
  - `git_graph_commit_times.sh` - generates GNUplot graphs of the GitHub commit times from all local adjacent Git repo checkouts listed in `setup/repos.txt` using Git log in each checkout
  - `git_graph_commit_times_mermaidjs.sh` - generates MermaidJS graphs of the GitHub commit times from all local adjacent Git repo checkouts listed in `setup/repos.txt` using Git log in each checkout
...
- `github/*.sh` - [GitHub](https://github.com/) API / CLI scripts:
  ...
  - `github_graph_commit_times.sh` - generates GNUplot graph of GitHub commit times from all public GitHub repos for a given user. Fetches the commit data via the GitHub API

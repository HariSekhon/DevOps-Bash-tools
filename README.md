...
- `github_*.sh` - [GitHub](https://github.com/) API / CLI scripts:
  ...
  - `github_push_pr.sh` - pushes to Gitub origin, sets upstream branch, then idemopotently creates a Pull Request from current branch to the given or default trunk branch and opens the PR in your browser

...
- `github_*.sh` - [GitHub](https://github.com/) API / CLI scripts:
  ...
  - `github_pull_request_preview.sh` - opens a GitHub Pull Request preview page from the current local branch to the default branch
  - `github_push_pr_preview.sh` - pushes to GitHub origin, sets upstream branch, then open a Pull Request preview from current branch to default trunk branch in your browser
  - `github_push_pr.sh` - pushes to Gitub origin, sets upstream branch, then idemopotently creates a Pull Request from current branch to default trunk branch and opens the PR in your browser

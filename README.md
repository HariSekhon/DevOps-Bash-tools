...
Used heavily by all my other [GitHub](https://github.com/harisekhon) repos and their 300+ [CI builds](https://github.com/HariSekhon/DevOps-Bash-tools/blob/master/STATUS.md).

...
- `git/*.sh` - [Git](https://git-scm.com/) scripts:
  ...
  - `git_origin_log_to_head.sh` - shows the Git log between the origin remote of the same branch to the current branch head. Can use the standard git log arg `--oneline` to count commits

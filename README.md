...
- `git/*.sh` - [Git](https://git-scm.com/) scripts:
  ...
  - `git_origin_linecount_to_push.sh` - shows the Git number of lines changed in local branch that would be pushed to remote origin. These are lines actually added / changed / removed without surrounding context lines

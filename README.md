...
- `kubectl_busybox.sh` / `kubectl_dnsutils.sh` / `kubectl_curl.sh` / `kubectl_alpine.sh` / `kubectl_gcloud_sdk.sh` - quick launch pods for interactive debuggging in Kubernetes

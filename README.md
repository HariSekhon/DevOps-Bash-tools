...
- [Google Cloud](https://cloud.google.com/) scripts - `gcp_*.sh` / `gce_*.sh` / `gke_*.sh` / `gcr_*.sh` / `bigquery_*.sh`:
  ...
  - `gcp_sql_*.sh` - [Cloud SQL](https://cloud.google.com/sql) scripts:
    ...
    - `gcp_sql_grant_instances_gcs_object_creator.sh` - grants minimal objectCreator permission to primary [Cloud SQL](https://cloud.google.com/sql) instances on the specified [GCS](https://cloud.google.com/storage) bucket for exports

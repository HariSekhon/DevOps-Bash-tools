...
- `mouse_random_movements.sh` - randomly moves the mouse around the screen to prevent a screensaver kicking in on a Remote Desktop connection which has Active Directory Group Policies applied that doesn't let you disable the screensaver

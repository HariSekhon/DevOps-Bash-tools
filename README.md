...
- `postgres.sh` - one-shot Postgres docker container boot + drop in to `psql` shell for quick testing, with `/sql` scripts mounted in container for easy `\i /sql/<name>.sql` sourcing of sql scripts

...
- `git*.sh` - various useful Git scripts like iterating all branches executing command arguments, submodule handling, merging master updates to all branches, auto-creating a checkout's remotes to the 3 major public repositories ([GitHub](https://github.com/)/[GitLab](https://gitlab.com/)/[Bitbucket](https://bitbucket.org)), setting up multi-remote origin for unified push to all 3 major public repositories etc.

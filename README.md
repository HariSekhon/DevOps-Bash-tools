...
- `gcp_*.sh` / `gce_*.sh` / `gke_*.sh` - [Google Cloud](https://cloud.google.com/) scripts:
  ...
  - `gcr_tag_datetime.sh` - finds and tags a given [Google Container Registry](https://cloud.google.com/container-registry) image with the UTC date and date-timestamp tags of when it was created (either uploaded or created by [Google Cloud Build](https://cloud.google.com/cloud-build))

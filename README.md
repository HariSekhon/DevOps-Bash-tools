...
- `github_*.sh` - [GitHub](https://github.com/) API scripts:
  ...
  - `github_mirror_repos_to_gitlab.sh` - creates/syncs GitHub backup repos on GitLab for fast free Disaster Recovery, including all branches and tags, plus the repo descriptions. Note this doesn't cover PRs/wikis/releases
  - `github_mirror_repos_to_bitbucket.sh` - creates/syncs GitHub backup repos on BitBucket for fast free Disaster Recovery, including all branches and tags, plus the repo descriptions. Note this doesn't cover PRs/wikis/releases

...
- `github_*.sh` - [GitHub](https://github.com/) API scripts:
  ...
  - `github_add_ssh_public_keys.sh` - uploads SSH keys from local files or standard input to the currently authenticated GitHub account. Specify pubkey files (default: `~/.ssh/id_rsa.pub`) or read from standard input for chaining with adjacent tools for GitLab / BitBucket
...
- `gitlab_*.sh` - [GitLab](https://gitlab.com/) API scripts:
  ...
  - `gitlab_add_ssh_public_keys.sh` - uploads SSH keys from local files or standard input to the currently authenticated GitLab account. Specify pubkey files (default: `~/.ssh/id_rsa.pub`) or read from standard input for chaining with adjacent tools for GitHub / BitBucket
...
- `bitbucket_*.sh` - [BitBucket](https://bitbucket.org/) API scripts:
  ...
  - `bitbucket_add_ssh_public_keys.sh` - uploads SSH keys from local files or standard input to the currently authenticated BitBucket account. Specify pubkey files (default: `~/.ssh/id_rsa.pub`) or read from standard input for chaining with adjacent tools for GitHub / GitLab
